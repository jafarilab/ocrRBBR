...
#'
#' @description This function predicts Boolean rule sets for a given gene using bulk-level multi-omics datasets,
...
ocrRBBR_bulk <- function(rnaseq_data, atacseq_data, gene_name, peak_ids, max_feature = NA, slope = NA, num_cores = NA){
  ...
  atacseq_mat <- log10(1 + atacseq_mat)
